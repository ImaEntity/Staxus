...
x86_64-w64-mingw32-gcc -m64 -Os -s -Wall -Werror -ffreestanding -c -o tmp/ff_psf.o src/file-formats/psf.c
x86_64-w64-mingw32-gcc -m64 -Os -s -Wall -Werror -ffreestanding -c -o tmp/vga_gop.o src/graphics/gop.c
x86_64-w64-mingw32-gcc -m64 -Os -s -Wall -Werror -ffreestanding -c -o tmp/io_format.o src/io/format.c
x86_64-w64-mingw32-gcc -m64 -Os -s -Wall -Werror -ffreestanding -c -o tmp/io_print.o src/io/print.c
x86_64-w64-mingw32-gcc -m64 -Os -s -Wall -Werror -ffreestanding -c -o tmp/mem_map.o src/memory/map.c
x86_64-w64-mingw32-gcc -m64 -Os -s -Wall -Werror -ffreestanding -c -o tmp/mem_alloc.o src/memory/alloc.c
...
x86_64-w64-mingw32-gcc -m64 -Os -s -nodefaultlibs -nostartfiles -nostdlib -Wl,-dll -shared -Wl,--subsystem,10 -e efi_main -o Z:/EFI/BOOT/BOOTX64.EFI tmp/io_format.o tmp/ff_psf.o tmp/bootloader.o tmp/efi_data.o

:: Compile and link the kernel, then shove it into the disk image
x86_64-w64-mingw32-gcc -m64 -O0 -s -Wall -Werror -ffreestanding -c -o tmp/krnltmp.o src/kernel.c
x86_64-w64-mingw32-gcc -m64 -Os -s -nostdlib -nodefaultlibs -nostartfiles -Wl,-N -Wl,-e,kernel_entry -o tmp/stxkrnl.o tmp/krnltmp.o tmp/mem_alloc.o tmp/io_format.o tmp/mem_map.o tmp/io_print.o tmp/vga_gop.o
